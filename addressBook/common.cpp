...
void database::createtable()
{
    ...
    else
    {
        ...
        //创建地址簿表(编号, 人员id, 头像, 姓名, 电话, 固话, 性别, 生日, QQ, 住址, 备注)
        query.exec("create table address(addressid int primary key, personid int, pic varchar, aname varchar, aphone varchar, atelephone varchar, aage int, abirth varchar, aqq varchar, aaddress varchar, anote varchar)");
