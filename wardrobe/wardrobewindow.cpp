...
void wardrobeWindow::on_pushButton_4_clicked()
{
    ...
    QString targetPath = "clothes/" + QString::number(idNum, 10) + ".jpg";
...
void wardrobeWindow::tableWidgetData()
{
    ...
    {
    case true:
        ui->tableWidget->setItem(i++, 0, new QTableWidgetItem(QString("衣服")));
        ui->tableWidget->setItem(i++, 0, new QTableWidgetItem(QString("饰品")));
        ui->tableWidget->setItem(i++, 0, new QTableWidgetItem(QString("包包")));
        ui->tableWidget->setItem(i++, 0, new QTableWidgetItem(QString("化妆品")));
        ui->tableWidget->setItem(i++, 0, new QTableWidgetItem(QString("鞋帽")));
