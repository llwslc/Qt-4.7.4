...
void phoneDialog::showEvent(QShowEvent *)
{
    currentTableModel->setTable("student");
    currentTableModel->select();
...
void phoneDialog::on_pushButton_clicked()
{
    //查询
    currentTableModel->setFilter("aphone like '%" + ui->lineEdit_5->text().trimmed() + "%'");
...
void phoneDialog::on_tableView_clicked(const QModelIndex &index)
{
    //列表单击
