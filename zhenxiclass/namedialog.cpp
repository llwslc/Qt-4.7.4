...
void nameDialog::showEvent(QShowEvent *)
{
    currentTableModel->setTable("student");
    currentTableModel->select();
...
{
    //查询
    currentTableModel->setFilter("aname like '%" + ui->lineEdit_5->text().trimmed() + "%'");
...
void nameDialog::on_tableView_clicked(const QModelIndex &index)
{
    //列表单击
