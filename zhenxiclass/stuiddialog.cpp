...
#include "ui_stuiddialog.h"

stuidDialog::stuidDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::stuidDialog)
{
    ui->setupUi(this);
...
stuidDialog::~stuidDialog()
{
    delete ui;
}

void stuidDialog::showEvent(QShowEvent *)
{
...
void stuidDialog::on_pushButton_clicked()
{
    //查询
    currentTableModel->setFilter("keeper like '%" + ui->lineEdit_5->text().trimmed() + "%'");
...
void stuidDialog::on_tableView_clicked(const QModelIndex &index)
{
    //列表单击
